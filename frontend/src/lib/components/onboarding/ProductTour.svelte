...
<svelte:head>
	{@html `<style>
		...
		.rusvel-tour-popover .driver-popover-title {
			color: #f1f5f9 !important;
			font-size: 14px !important;
		}
		.rusvel-tour-popover .driver-popover-description {
			color: #94a3b8 !important;
			font-size: 13px !important;
		}
		.rusvel-tour-popover .driver-popover-progress-text {
			color: #64748b !important;
		}
		.rusvel-tour-popover button {
		...
		.rusvel-tour-popover .driver-popover-close-btn {
