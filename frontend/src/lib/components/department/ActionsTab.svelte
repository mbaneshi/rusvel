...
<div class="p-3 space-y-2">
	...
	>
		...
		<p class="text-[10px] text-muted-foreground">Describe what you need — AI discovers & installs</p>
	</button>
	...
	{#each quickActions as action}
		...
		>
			<p class="text-xs font-medium text-foreground group-hover:opacity-90" style="--accent: hsl({deptHsl})">
				{action.label}
			</p>
		</button>
	{/each}
