...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_DLHsrwWI.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CSjjXyL-.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BKVoJM6P.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DPFyz3mM.mjs');
...
const starlightConfig = {"description":"The Solo Builder's AI-Powered Virtual Agency","social":{"github":{"label":"GitHub","url":"https://github.com/mbaneshi/all-in-one-rusvel"}},"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Getting Started","translations":{},"collapsed":false,"autogenerate":{"directory":"getting-started"}},{"label":"Concepts","translations":{},"collapsed":false,"autogenerate":{"directory":"concepts"}},{"label":"Departments","translations":{},"collapsed":false,"autogenerate":{"directory":"departments"}},{"label":"Reference","translations":{},"collapsed":false,"autogenerate":{"directory":"reference"}},{"label":"Architecture","translations":{},"collapsed":false,"autogenerate":{"directory":"architecture"}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"RUSVEL"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///Users/bm/all-in-one-rusvel/docs-site/","srcDir":"file:///Users/bm/all-in-one-rusvel/docs-site/src/","trailingSlash":"ignore"};
